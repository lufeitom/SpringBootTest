...
//		JEDIS_IP = ConfigUtils.getInstance().getProperty("jedis.ip", "127.0.0.1");
//		JEDIS_PORT = ConfigUtils.getInstance().getPropertyInteger("jedis.port", "6379");
//		JEDIS_PASSWORD = ConfigUtils.getInstance().getProperty("jedis.password", "123456");
